...
const createServer = (
  ...
  const rootCorsMiddleware = cors({
    origin,
    optionsSuccessStatus: 200
  })

  const endpointsCorsMiddleware = cors({
    origin: endpointsOrigin,
    optionsSuccessStatus: 200
  })
  ...
  // routes
  app.get('/_live', endpointsCorsMiddleware, (req, res) => {
    sse.addClient(req, res)
  })

  app.get('/_stats', endpointsCorsMiddleware, (req, res) => {
  ...
  app.options('/', rootCorsMiddleware)
